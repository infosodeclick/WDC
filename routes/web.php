...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/workflows/{workflowRequest}/report', [WorkflowController::class, 'report'])->name('workflows.report');
    Route::get('/workflows/{workflowRequest}', [WorkflowController::class, 'show'])->name('workflows.show');
    ...
    Route::post('/workflows/templates/{template}/fields', [WorkflowController::class, 'storeTemplateField'])->name('workflows.fields.store');
    Route::patch('/workflows/templates/{template}/fields/{fieldKey}', [WorkflowController::class, 'updateTemplateField'])->name('workflows.fields.update');
    Route::delete('/workflows/templates/{template}/fields/{fieldKey}', [WorkflowController::class, 'destroyTemplateField'])->name('workflows.fields.destroy');
    ...
    Route::post('/workflows/{workflowRequest}/favorite', [WorkflowController::class, 'toggleRequestFavorite'])->name('workflows.requests.favorite');
