...
<div class="content-grid">
    ...
    <section class="panel"><h2>สมุดโทรศัพท์</h2>@include('search.partials.simple-list', ['items' => $directoryEntries, 'titleField' => 'display_name', 'subtitleField' => 'department'])</section>
