...
class Permission extends Model
{
    ...
    public const CATALOG = [
        ...
        ['key' => 'announcements.view', 'group' => 'Content', 'name' => 'ดูประกาศ', 'description' => 'อ่านข่าวสารและประกาศบริษัท', 'sort_order' => 40],
        ['key' => 'knowledge.view', 'group' => 'Content', 'name' => 'ดูศูนย์ความรู้', 'description' => 'อ่านคู่มือและดูวิดีโอความรู้', 'sort_order' => 50],
        ['key' => 'documents.view', 'group' => 'Content', 'name' => 'ดู/ดาวน์โหลดเอกสาร', 'description' => 'เปิดเอกสารบริษัทและเอกสารของตนเอง', 'sort_order' => 60],
        ...
        ['key' => 'tickets.create', 'group' => 'IT Helpdesk', 'name' => 'เปิด Ticket', 'description' => 'แจ้งปัญหา IT และติดตามงานของตนเอง', 'sort_order' => 100],
        ['key' => 'tickets.manage', 'group' => 'IT Helpdesk', 'name' => 'จัดการ Ticket', 'description' => 'เห็นและอัปเดต Ticket ตามขอบเขตข้อมูล', 'sort_order' => 110],
        ...
        ['key' => 'complaints.create', 'group' => 'HR & Compliance', 'name' => 'ส่งเรื่องร้องเรียน/เสนอแนะ', 'description' => 'ส่งเรื่องถึง HR หรือผู้บริหาร', 'sort_order' => 150],
